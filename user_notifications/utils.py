...
def send_email_notification(notification):
    ...
    try:
        ...
        # Send email (simplified for now - you can create templates later)
        ...
        You can view more details by visiting our platform.
        ...
        send_mail(
            subject=subject,
            message=message,
            from_email=getattr(settings, 'DEFAULT_FROM_EMAIL', 'noreply@elevateworkforce.com'),
